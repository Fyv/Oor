databaseChangeLog = {
	...
	changeSet(author: "Fyv (generated)", id: "1360665504693-1") {
	...
	changeSet(author: "Fyv (generated)", id: "1360665504693-2") {
	...
	changeSet(author: "Fyv (generated)", id: "1360665504693-3") {
		dropColumn(columnName: "famille", tableName: "patient")
	}

	changeSet(author: "Fyv (generated)", id: "1360665504693-4") {
		dropTable(tableName: "persistent_session")
	}

	changeSet(author: "Fyv (generated)", id: "1360665504693-5") {
		dropTable(tableName: "persistent_session_attribute")
	}

	changeSet(author: "Fyv (generated)", id: "1360665504693-6") {
